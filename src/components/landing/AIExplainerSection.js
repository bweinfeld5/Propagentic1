      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="mt-6 inline-flex items-center">
            <span className="text-orange-500 dark:text-orange-400 font-semibold">This entire process took only 28 seconds</span>
            <div className="ml-2 h-2 w-2 rounded-full bg-orange-500 dark:bg-orange-400 animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-xl border border-gray-100 dark:border-gray-600">
              <div className="p-6">
                  ...
                  {workflowSteps.map((step, index) => (
                    ...
                    >
                      <div className="mr-4 mt-1 flex-shrink-0">
                        <div className={`h-6 w-6 rounded-full ${activeStep === index ? 'bg-white text-orange-500' : 'bg-orange-100 dark:bg-orange-900/30 text-orange-500 dark:text-orange-300'} flex items-center justify-center text-sm font-medium`}>
                          {index + 1}
                        </div>
                      </div>
                      <div>
                ...
                <div className="mt-6 flex justify-center">
                  <button
                    ...
                    className="flex items-center px-6 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-all duration-200 shadow-md hover:shadow-lg"
                  >
          ...
          <div className="lg:col-span-3">
            <div className={`bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-xl p-8 shadow-xl transition-all duration-300 ${isHighlighted ? 'transform scale-[1.02]' : ''}`}>
              <div className="flex items-center mb-8">
                ...
                <div className="ml-6">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{workflowSteps[activeStep].title}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    <span className="inline-block px-3 py-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 text-xs font-medium mr-2">{workflowSteps[activeStep].role}</span>
              ...
              <div className="mt-8 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-gray-800 dark:to-gray-700 rounded-lg p-8 shadow-inner">
                <div className="flex items-center justify-center h-48">
                  <div className="text-center">
                    {/* This would ideally be replaced with custom illustrations for each step */}
                    <div className="flex items-center justify-center h-20 w-20 mx-auto rounded-full bg-white dark:bg-gray-600 shadow-md">
                      <div className="text-orange-500 dark:text-orange-400">{workflowSteps[activeStep].icon}</div>
                    </div>
                    <p className="mt-4 text-gray-700 dark:text-gray-300 font-medium">
                      {workflowSteps[activeStep].role === 'Tenant' ? 'Tenant App Interface' : 
                       workflowSteps[activeStep].role === 'Landlord' ? 'Landlord Dashboard' :
                       workflowSteps[activeStep].role === 'Contractor' ? 'Contractor Mobile App' :
                       'PropAgentic AI System'}
                    </p>
                  </div>
                </div>
              </div>
