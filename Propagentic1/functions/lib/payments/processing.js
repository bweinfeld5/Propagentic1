...
exports.refundPayment = exports.getContractorEarnings = exports.getPaymentDetails = exports.getContractorPayments = exports.createJobPayment = void 0;
...
exports.createJobPayment = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        if ((jobData === null || jobData === void 0 ? void 0 : jobData.status) !== 'completed') {
            throw new functions.https.HttpsError('failed-precondition', 'Job must be completed before payment');
        }
        if ((jobData === null || jobData === void 0 ? void 0 : jobData.contractorId) !== contractorId) {
        ...
        if (!(contractorData === null || contractorData === void 0 ? void 0 : contractorData.stripeAccountId)) {
...
exports.getContractorPayments = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        const payments = paymentsSnapshot.docs.map(doc => (Object.assign(Object.assign({ id: doc.id }, doc.data()), { totalAmount: doc.data().totalAmount / 100, contractorAmount: doc.data().contractorAmount / 100, platformFee: doc.data().platformFee / 100 })));
        return { payments };
    }
    catch (error) {
...
// Get payment details
exports.getPaymentDetails = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        if (context.auth.uid !== (paymentData === null || paymentData === void 0 ? void 0 : paymentData.contractorId) && context.auth.uid !== (paymentData === null || paymentData === void 0 ? void 0 : paymentData.landlordId)) {
        ...
        if (paymentData === null || paymentData === void 0 ? void 0 : paymentData.stripeTransferId) {
            try {
        ...
        return Object.assign(Object.assign({ id: paymentDoc.id }, paymentData), { totalAmount: paymentData.totalAmount / 100, contractorAmount: paymentData.contractorAmount / 100, platformFee: paymentData.platformFee / 100, // Convert to dollars
            stripeDetails });
    }
    catch (error) {
...
exports.getContractorEarnings = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
...
exports.refundPayment = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const paymentData = paymentDoc.data();
        if ((paymentData === null || paymentData === void 0 ? void 0 : paymentData.status) === 'refunded') {
