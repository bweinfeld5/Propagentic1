...
exports.sendInviteCodeEmail = void 0;
 ...
 */
exports.sendInviteCodeEmail = (0, firestore_1.onDocumentCreated)('inviteCodes/{inviteId}', async (event) => {
        ...
        if (inviteData.propertyId) {
            try {
                ...
                if (propertyDoc.exists) {
                    ...
                    propertyName = (propertyData === null || propertyData === void 0 ? void 0 : propertyData.name) || (propertyData === null || propertyData === void 0 ? void 0 : propertyData.nickname) || (propertyData === null || propertyData === void 0 ? void 0 : propertyData.title) || 'Property';
                }
            }
            catch (error) {
        ...
        if (inviteData.landlordId) {
            try {
                ...
                if (landlordDoc.exists) {
                    ...
                    landlordName = (landlordData === null || landlordData === void 0 ? void 0 : landlordData.displayName) || (landlordData === null || landlordData === void 0 ? void 0 : landlordData.firstName) || (landlordData === null || landlordData === void 0 ? void 0 : landlordData.name) || 'Property Owner';
                }
            }
            catch (error) {
...
function generateInviteEmailHtml(params) {
    const { tenantEmail, inviteCode, landlordName, propertyName, unitInfo, appDomain, inviteUrl } = params;
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
//# sourceMappingURL=inviteCodeEmailTrigger.js.map