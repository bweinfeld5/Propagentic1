  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-white to-orange-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
          <div className="md:flex">
            ...
            <div className="md:flex-shrink-0 flex items-center justify-center p-8 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-gray-800 dark:to-gray-700">
              <div className="h-56 w-56 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center overflow-hidden border-4 border-white dark:border-gray-700 shadow-lg">
            ...
            <div className="p-8 md:p-10">
              ...
              <p className="text-orange-600 dark:text-orange-400 font-medium mb-6">Founder & CEO, Propagentic</p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="https://linkedin.com/in/benweinfeld" target="_blank" rel="noopener noreferrer" 
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-orange-600 hover:bg-orange-700 transition-colors">
                ...
                <a href="mailto:ben@propagentic.com" 
                   className="inline-flex items-center justify-center px-5 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-lg text-gray-700 dark:text-white bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
