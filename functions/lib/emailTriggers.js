...
exports.sendPropertyInviteEmail = exports.sendInviteCodeEmail = void 0;
 ...
 */
exports.sendInviteCodeEmail = (0, firestore_1.onDocumentCreated)('inviteCodes/{codeId}', async (event) => {
    ...
    logger.info('Invite code created, processing email...', {
        codeId,
        email: codeData === null || codeData === void 0 ? void 0 : codeData.email,
        propertyId: codeData === null || codeData === void 0 ? void 0 : codeData.propertyId
    });
    // Only send email if email field is provided
    if (!(codeData === null || codeData === void 0 ? void 0 : codeData.email)) {
 ...
 */
exports.sendPropertyInviteEmail = (0, firestore_1.onDocumentCreated)('invites/{inviteId}', async (event) => {
    const snap = event.data;
    if (!snap) {
    ...
    logger.info('Property invite created, processing email...', {
        inviteId,
        tenantEmail: inviteData === null || inviteData === void 0 ? void 0 : inviteData.tenantEmail,
        propertyId: inviteData === null || inviteData === void 0 ? void 0 : inviteData.propertyId
    });
