...
exports.sendTestEmailUnified = exports.sendPropertyInvitationEmailUnified = exports.sendEmailViaUnifiedService = void 0;
 ...
 */
const sendEmailViaUnifiedService = async (emailData) => {
    try {
        ...
        const mailData = {
            ...
            metadata: Object.assign({ sentAt: new Date().toISOString(), source: 'unifiedEmailService', version: '2.0', format: 'message_wrapper' }, emailData.metadata)
        };
...
exports.sendEmailViaUnifiedService = sendEmailViaUnifiedService;
/**
 * PROPERTY INVITATION EMAIL - Using unified service
 */
const sendPropertyInvitationEmailUnified = async (inviteData) => {
...
© ${new Date().getFullYear()} PropAgentic. All rights reserved.
  `;
    ...
    const mailDocId = await (0, exports.sendEmailViaUnifiedService)(emailData);
...
exports.sendPropertyInvitationEmailUnified = sendPropertyInvitationEmailUnified;
/**
 * TEST EMAIL - Using unified service
 */
const sendTestEmailUnified = async (testEmail) => {
    const emailData = {
        to: testEmail,
    ...
    return await (0, exports.sendEmailViaUnifiedService)(emailData);
};
exports.sendTestEmailUnified = sendTestEmailUnified;
