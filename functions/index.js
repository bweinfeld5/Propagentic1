...
// Contractor Job Actions functions (bid accept/reject) - NEW
try {
  const contractorJobActions = require('./lib/contractorJobActions');
  exports.contractorAcceptJob = contractorJobActions.contractorAcceptJob;
  exports.contractorRejectJob = contractorJobActions.contractorRejectJob;
  exports.getContractorBidsForJob = contractorJobActions.getContractorBidsForJob;
  console.log('✅ Loaded contractorJobActions functions (bid management)');
} catch (error) {
  console.error('❌ Failed to load contractorJobActions functions:', error.message);
}
